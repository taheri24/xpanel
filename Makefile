...
build-siamak: ## Build Windows backend with embedded www, copy sage-app files, and create deployment zip
	...
	@echo ""
	@echo "[1/4] Building frontend and copying to backend/www..."
